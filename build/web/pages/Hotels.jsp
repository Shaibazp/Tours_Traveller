                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                                <h1><b>Hotels Information</b></h1>
                            </div>
                        </div>
                        <form method="post" action="/hotelUrl" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Hotel Name" name="hotelnm">
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <section>
                                                <select class="cs-select cs-skin-border" name="hreagion">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Mobile Number" name="hmobileno">
                                            </div>
                                        </div>
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <div class="form-group">
