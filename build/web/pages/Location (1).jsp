...
<!-- Mirrored from www.free-css.com/assets/files/free-css-templates/preview/page231/travel/pages/hotel.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Dec 2021 17:27:19 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<title>Free CSS | Free CSS Templates | Demo of the HTML CSS Template Travel | Pages | Hotel</title>
<meta charset="utf-8">
...
<div id="fh5co-wrapper">
  <div id="fh5co-page">
              ...
              <li><a href="https://www.free-css.com/free-css-templates">Home</a></li>
               <li><a href="vacation.html" class="fh5co-sub-ddown">How to Reach</a>
                <ul class="fh5co-sub-menu">
                  <li><a href="https://www.free-css.com/free-css-templates">Cab</a></li>
                  <li><a href="https://www.free-css.com/free-css-templates">Bus</a></li>
                  <li><a href="https://www.free-css.com/free-css-templates">Flights</a></li>
    ...
    <div class="fh5co-hero">
      ...
      <div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image:url(../assets/images/cover_bg_5.jpg);">
        <div class="desc">
          <div class="container">
            <div class="row">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 animate-box">
            ...
            <a href="https://www.free-css.com/free-css-templates">Read More <i class="icon-arrow-right22"></i></a></div>
          <div class="col-md-6 animate-box"><img class="img-responsive" src="../assets/images/cover_bg_2.jpg" alt="website template image"></div>
        </div>
          <br><br>
          ...
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div><img src="../assets/images/place-1.jpg" alt="website template image" class="img-responsive">
              <div class="desc"><span></span>
                <h3>New York</h3>
                <span>3 nights</span><span class="price">$1,000</span><a class="btn btn-primary btn-outline" href="https://www.free-css.com/free-css-templates">Book Now <i class="icon-arrow-right22"></i></a></div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
            <div><img src="../assets/images/place-2.jpg" alt="website template image" class="img-responsive">
              <div class="desc"><span></span>
                <h3>Philippines</h3>
                <span>4 nights</span><span class="price">$1,000</span><a class="btn btn-primary btn-outline" href="https://www.free-css.com/free-css-templates">Book Now <i class="icon-arrow-right22"></i></a></div>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
              ...
              <p>Copyright <a href="https://www.free-css.com/free-css-templates">Module</a>. All Rights Reserved.<br>
                Made with <i class="icon-heart3"></i> by <a target="_blank" rel="nofollow noopener" href="http://freehtml5.co/">FreeHTML5.co</a> / Demo Images: Unsplash</p>
            </div>
          </div>
        </div>
      </div>
...
<!-- Mirrored from www.free-css.com/assets/files/free-css-templates/preview/page231/travel/pages/hotel.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Dec 2021 17:27:20 GMT -->
</html>