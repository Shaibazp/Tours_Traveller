...
<html class="no-js">
            ...
            <div id="fh5co-page">
                ...
                <div id="fh5co-contact" class="fh5co-section-gray">
                    <div class="container">
                        ...
                        <form method="post" action="addvehicledb.jsp" >
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <input type="text" class="form-control" placeholder="car Name" name="cnm">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <section>
                                                <select class="cs-select cs-skin-border" name="acnonac">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <section>
                                                <select class="cs-select cs-skin-border" name="vtype">
                                                    <option value="" disabled selected>Select Type</option>
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            ...
                                            <input type="text" class="form-control" placeholder="Driver Name" name="dname">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            ...
                                            <input type="text" class="form-control" placeholder="Driver Contact No" name="dcno">
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <b>Rate(Per/km)</b>
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            ...
                                            <input type="text" class="form-control" placeholder="KM Rate" name="kmrate">
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="submit" value="Add" class="btn btn-primary" style="margin-left: 250px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Mirrored from www.free-css.com/assets/files/free-css-templates/preview/page231/travel/pages/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 30 Dec 2021 17:27:24 GMT -->
</html>