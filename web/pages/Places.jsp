                        ...
                        <div class="nav-header"><a href="javascript:void(0)" class="js-fh5co-nav-toggle fh5co-nav-toggle dark"><i></i></a>
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li class="active"><a href="Places.jsp">Add Places</a></li>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <section>
                                                <select class="cs-select cs-skin-border" name="season">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <section>
                                                <select class="cs-select cs-skin-border" name="reagion">
                                                    <option value="" disabled selected>Select Reagion</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea class="form-control" cols="30" rows="7" placeholder="Summery of Place" name="info"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            Add Photos
                                            ...
                                            <div class="form-group">
                                                <input type="file" id="myFile" name="photo2">
                                            </div>
                                        </div> 
                                        <div class="col-md-12">
                                            <div class="form-group">
