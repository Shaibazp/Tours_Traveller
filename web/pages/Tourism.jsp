                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                                <h1><b>Add Tourism</b></h1>
                            </div>
                        </div>
                        <form method="post" action="addStoDKM.jsp" >
                            <div class="row animate-box">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            <input type="text" class="form-control" placeholder="Source Name" name="snm">
                                        ...
                                        <div class="col-xxs-12 col-xs-6 mt">
                                            ...
                                            <input type="text" class="form-control" placeholder="Distance" name="skm">
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
